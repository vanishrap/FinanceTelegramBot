...
WORKDIR /src
COPY . .
RUN dotnet restore src/FinanceBot.Worker/FinanceBot.Worker.csproj && \
    dotnet publish src/FinanceBot.Worker/FinanceBot.Worker.csproj -c Release -o /app --no-restore
