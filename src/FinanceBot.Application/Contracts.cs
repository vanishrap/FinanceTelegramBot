...
public sealed record FinanceOptions
{
    ...
    public int MessageBatchDelaySeconds { get; init; } = 300;
...
public sealed record ExtractedOperation(string Kind, decimal Amount, string Currency, string Description, string? Merchant, long? AccountId, long? ToAccountId, ReceiptDraft? Receipt);
